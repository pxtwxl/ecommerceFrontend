...
import NavbarUserProfileButton from "./NavbarUserProfileButton";
      ...
      <header>
        <nav className="navbar navbar-expand-lg fixed-top">
          <div className="container-fluid">
            <a className="navbar-brand" href="https://in.linkedin.com/in/anuj-patwal-prof">
              SmartCart
            </a>
            <button
            ...
            >
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                {user && user.role === "BUYER" && (
                  <li className="nav-item">
                    <a className="nav-link" href="/comparator">
                      <span style={{ fontWeight: 600, color: '#7c3aed', fontSize: '1rem', letterSpacing: '0.2px' }}>
                        SaverrAI
                      </span>
                    </a>
                  </li>
